...
<?
				...
				//echo $_POST["textemployee"];
				//echo $_POST["textdate"];
				//echo $_POST["texttime"];
				//echo $_POST["textcar"];
				//echo $_POST["textsubject"];
	...
	date_default_timezone_set("Asia/Bangkok"); //ตั้ง timezone
			...
			while($row_show = mysql_fetch_array($result_show)){
				...
				//echo $newdate; //วันที่เข้างานใหม่ Datepicker
				//$Date_In=$sY1."/".$sM1."/".$sD1; ไม่ได้ใช้แล้ว
				...
				function DateThai($strDate) //แปลง Date/Time = Thai Date/Time
					...
					$sqlser="insert into subject (namecus,make,location,employee,starttime,endtime,subject,userid,carid,time_in,coor_Latitute,coor_Longitute) 
