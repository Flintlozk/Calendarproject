...
<html>
  ...
  <body>
    ...
    <script>
      ...
      function initAutocomplete() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 13.730995466424108, lng: 100.51986257812496},
          zoom: 13,
          mapTypeId: 'roadmap'
        });
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=initAutocomplete&sensor=false&language=th"
         async defer></script>
  </body>
</html>